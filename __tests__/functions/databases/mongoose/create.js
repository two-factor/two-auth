...
// note: Mocha is required for these tests to run
  ...
  describe('tests the create/verify/send functions for Mongoose', () => {
    ...
    class FakeClient {
      constructor(AccSID, AuthToken) {
        ...
        this.TwoAuthUser = {
          create: ({ userID, sid, phone }) => new Promise((resolve, reject) => {
